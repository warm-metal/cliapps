...
app-context-bash-alpine:
	kubectl dev build -f bash-alpine.dockerfile -t docker.io/warmmetal/app-context-bash-alpine:v0.1.0 app-context

.PHONY: app-context-bash-ubuntu
app-context-bash-ubuntu:
	kubectl dev build -f bash-ubuntu.dockerfile -t docker.io/warmmetal/app-context-bash-ubuntu:v0.1.0 app-context
